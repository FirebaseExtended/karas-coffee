...
export function Privacy() {
  return (
    <section className="max-w-3xl px-4 mx-auto mt-24 lg:px-0">
      ...
      <div className="mt-12 prose max-w-none">
        ...
        <h3>Third Party Consent</h3>
        <p>
          All third-party product names, logos, and brands are property of their respective owners. All third-party
          company, product and service names used in this website are for identification purposes only. Use of these
          names, logos, and brands does not imply copyright ownership.
        </p>
        <h3>Information Collection and Use</h3>
        <p>
          We collect several different types of information for various purposes to provide and improve our Service to
          you. We do not share your email address to third-parties or use it for marketing purposes. Email addresses are
          used for transactional emails only e.g. purchase or invoice emails.
        </p>
        <h3>Personal Data</h3>
        <p>
          ...
          is not limited to: Cookies & Usage Data, Email, Usage Data.
        </p>
        <p>
          We may also collect information how the Service is accessed and used (Usage Data). This Usage Data may include
          information such as your, browser type, browser version, the pages of our Service that you visit, the time and
        ...
        <p>
          We may disclose your Personal Data in the good faith belief that such action is necessary to: To comply with a
          legal obligation. To protect and defend the rights or property. To prevent or investigate possible wrongdoing
          in connection with the Service. To protect the personal safety of users of the Service or the public. To
        ...
        <p>
          ...
          you will be directed to that third party site. We strongly advise you to review the Privacy Policy of every
