...
export function SignIn() {
  ...
  return (
    <section className="max-w-xl mx-auto my-20">
      <h1 className="text-3xl font-extrabold text-center mb-10 text-gray-900">Sign in to your account</h1>
        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              id="email"
              value=""
              className="bg-white w-full px-2 py-1 border rounded focus:outline-none focus:border-gray-500"
              placeholder=""
            />
          </div>
          <div>
